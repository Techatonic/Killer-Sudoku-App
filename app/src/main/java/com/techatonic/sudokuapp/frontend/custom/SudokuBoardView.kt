        ...
        cells?.forEach { cell ->
            ...
            if (value == 0) {
                ...
                cell.notes.forEach { note ->
                    ...
                    canvas.drawText(
                        valueString,
                        (cell.col * cellSizePixels) + (colInCell * noteSizePixels) + noteSizePixels - textWidth / 2f,
        ...
        this.cages?.forEach { cage ->
            ...
            for ((index, cell) in cells.withIndex()) {
                ...
                if (index == 0) {
                    ...
                    canvas.drawText(
                        valueString,
                        (cell.second * cellSizePixels) + noteSizePixels / 2 - textWidth * 1 / 4f,
                ...
                // Top-right corner
                if (
                    cells.any { it.first == cell.first - 1 && it.second == cell.second } &&
